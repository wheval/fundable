...
//             >(),
//             184313527_u256,
//         ), // 556838 * 331, STRK highest_holder ->
//         0x00ca1702e64c81d9a07b86bd2c540188d92a2c73cf5cc0e508d949015e7e84a7 (
//             contract_address_const::<
...
//     assert(
//         token.balance_of(contract_address_const::<0x2>()) == 100_u256, 'Wrong balance recipient
//         1',
//     );
//     assert(
//         token.balance_of(contract_address_const::<0x3>()) == 200_u256, 'Wrong balance recipient
//         2',
//     );
//     assert(
//         token.balance_of(contract_address_const::<0x4>()) == 300_u256, 'Wrong balance recipient
//         3',
//     );
// }
...
//     assert(token.balance_of(protocol_address) == protocol_fee, 'Protocol fee transfer
//     incorrect');
// }
...
//     // Create recipients array
//     let mut recipients = array![contract_address_const::<0x2>(),
//     contract_address_const::<0x3>()];
...
//     assert(
//         distributor.get_token_stats(token_address).distribution_count == 0, 'wrong initial
//         state',
//     );
//     assert(
...
//     //Assert token stats
//     assert(distributor.get_user_stats(sender).distributions_initiated == 0, 'wrong initial
//     state');
//     assert(distributor.get_user_stats(sender).total_amount_distributed == 0, 'wrong initial
//     state');
//     assert(distributor.get_user_stats(sender).last_distribution_time == 0, 'wrong initial
//     state');
