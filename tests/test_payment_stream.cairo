...
// use fundable::interfaces::IPaymentStream::{IPaymentStreamDispatcher,
// IPaymentStreamDispatcherTrait};
...
//         .create_stream(recipient, total_amount, duration, cancelable, token_address,
//         transferable);
...
//     let (token_address, sender, payment_stream, access_control, _erc721) =
...
//         .create_stream(
//             sender, // recipient
//             total_amount, // amount (1 token in 6 decimals)
//             duration, // duration
...
//         .create_stream(
//             sender, // recipient
//             total_amount, // 100 tokens (0 decimals)
//             duration, // duration
//             cancelable, // cancelable
//             token_address, // token with 0 decimals
//             transferable // transferable
//         );
...
//     let (token_address, sender, payment_stream) = setup_custom_decimals(test_decimals);
//     let total_amount = 1000000000000000000_u256;
//     let duration = 30_u64;
//     let cancelable = true;
//     let transferable = true;
...
//         .create_stream(
//             sender, // recipient
//             total_amount, // 1 token
//             duration, // duration
//             cancelable, // cancelable
//             token_address, // token with 18 decimals
//             transferable // transferable
//         );
...
//     let (token_address, sender, payment_stream) = setup_custom_decimals(test_decimals);
//     let total_amount = 10000000000000000000_u256;
//     let duration = 30_u64;
//     let cancelable = true;
//     let transferable = true;
...
//         .create_stream(
//             sender18, // recipient
//             total_amount, // 1 token in 18 decimals
//             duration, // duration
//             cancelable, // cancelable
...
//         .create_stream(
//             sender0, // recipient
//             total_amount, // 100 tokens in 0 decimals
//             duration, // duration
//             cancelable, // cancelable
